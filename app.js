//Name : Faraz Ahmed Khan, Date:28/9/2022
...
guestForNewTable.forEach(element => {
  ...
  var   twoComingGuest  = guestForNewTable.filter(function( obj ) {
        return (obj.living !== false && obj.name !== "faraz" && obj.name !== "zafir" && obj.canMakeIt !==false);
    });
...
var locations = ["Karachi", "Lahore","Islamabad","America", "Rawalpindi" ]
...
} else if ( favorite_fruits.includes('apples'))
    {console.log("You really like apples!")}
else  if ( favorite_fruits.includes('blueberries'))
    {console.log("You really like blueberries!")}
else if (favorite_fruits.includes('kiwis'))
    {console.log("You really like kiwis!")}
else if( favorite_fruits.includes( 'peaches'))
